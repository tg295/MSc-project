...
%     Data(i).ik = tmp.data(:,7);
    ...
    Data(i).ik = tmp.data(:,7);
    Data(i).ina = tmp.data(:,8);
    Data(i).para100 = tmp.data(:,9);
    Data(i).para101 = tmp.data(:,10);
    Data(i).para102 = tmp.data(:,11);
    Data(i).para103 = tmp.data(:,12);
    Data(i).para104 = tmp.data(:,13);
    Data(i).vmstart = tmp.data(:,14);
    Data(i).vmend = tmp.data(:,15);
...
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).para100(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('para100','fontsize',20);
legend boxoff
hold off 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).para101(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).para102(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('para102','fontsize',20);
legend boxoff
hold off 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).para103(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('para103','fontsize',20);
legend boxoff
hold off 
%% 
d=parula(5);
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).para104(:),'color',d(i,:),'linewidth',1);
end 
legend({'1.4mA','1.5mA','1.6mA','1.7mA','1.8mA'})
legend('location','southeast')
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('para104','fontsize',20);
legend boxoff
hold off 
%% 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).vm05(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('vm','fontsize',20);
legend boxoff
hold off 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).vmstart(:),'color',d(i,:),'linewidth',0.5);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('Vm Node 1','fontsize',20);
legend boxoff
hold off 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).vmend(:),'color',d(i,:),'linewidth',0.5);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('Vm Node 36','fontsize',20);
legend boxoff
hold off 
%% Currents 
d=parula(5);
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).ik(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('K^+ current (mA/cm^2)','fontsize',16);
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).ina(:),'color',d(i,:),'linewidth',1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
legend('location','southeast')
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylabel('Na^+ current (mA/cm^2)','fontsize',20);
legend boxoff
hold off 
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).m(:),'color',d(i,:),'linewidth',0.1);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
% xlim([33 35])
% xticks([33 34 35])
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t(:), Asorted(i).h(:),'color',d(i,:),'linewidth',0.35);
end 
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'})
xlabel('Time (ms)','fontsize',14);
...
legend({'6kHz','7kHz','8kHz','9kHz','10kHz'},'location','southeast')
% xlim([33 35])
% xticks([33 34 35])
xlabel('Time (ms)','fontsize',14);
ylim([0 1])
