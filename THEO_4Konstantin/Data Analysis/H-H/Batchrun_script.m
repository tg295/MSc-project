...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t([33000:35000]), Asorted(i).m([33000:35000]),'color',d(i,:),'linewidth',1);
end 
legend({'8kHz','9kHz','10kHz','11kHz','12kHz'})
xlim([33 35])
xticks([33 34 35])
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t([32000:40000]), Asorted(i).h([32000:40000]),'color',d(i,:),'linewidth',1);
end 
legend({'8kHz','9kHz','10kHz','11kHz','12kHz'})
xlabel('Time (ms)','fontsize',14);
...
hold on
for i = 1:length(Asorted)
    plot(Asorted(i).t([32000:40000]), Asorted(i).n([32000:40000]),'color',d(i,:),'linewidth',1);
end 
legend({'8kHz','9kHz','10kHz','11kHz','12kHz'})
xlabel('Time (ms)','fontsize',14);
