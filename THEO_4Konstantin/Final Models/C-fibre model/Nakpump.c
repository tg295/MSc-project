...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "na_ion");
 	...
 	ivoc_help("help ?1 NaKpump C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF5/Nakpump.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ik = gp / ( pow( ( 1.0 + 1.0 / ko ) , 2.0 ) ) * ( 1.62 / ( 1.0 + pow( ( 6.7 / ( nai + 8.0 ) ) , 3.0 ) ) + 1.0 / ( 1.0 + pow( ( 67.6 / ( nai + 8.0 ) ) , 3.0 ) ) ) ;
   ina = - 3.0 / 2.0 * ik ;
   }
 _current += ik;
 _current += ina;
