...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav1p8 C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF5/nav1p8.mod\n");
...
double alpham ( _threadargsprotocomma_ double _lv ) {
   double _lalpham;
 _lalpham = 2.85 - 2.839 / ( 1.0 + exp ( ( _lv - 1.159 ) / 13.95 ) ) ;
...
double alphas ( _threadargsprotocomma_ double _lv ) {
   double _lalphas;
 _lalphas = 0.001 * 5.4203 / ( 1.0 + exp ( ( _lv + 79.816 ) / 16.269 ) ) ;
...
double alphau ( _threadargsprotocomma_ double _lv ) {
   double _lalphau;
 _lalphau = 0.0002 * 2.0434 / ( 1.0 + exp ( ( _lv + 67.499 ) / 19.51 ) ) ;
...
double betam ( _threadargsprotocomma_ double _lv ) {
   double _lbetam;
 _lbetam = 7.6205 / ( 1.0 + exp ( ( _lv + 46.463 ) / 8.8289 ) ) ;
...
double betas ( _threadargsprotocomma_ double _lv ) {
   double _lbetas;
 _lbetas = 0.001 * 5.0757 / ( 1.0 + exp ( - ( _lv + 15.968 ) / 11.542 ) ) ;
...
double betau ( _threadargsprotocomma_ double _lv ) {
   double _lbetau;
 _lbetau = 0.0002 * 1.9952 / ( 1.0 + exp ( - ( _lv + 30.963 ) / 14.792 ) ) ;
...
double rates ( _threadargsprotocomma_ double _lv ) {
 ...
 tau_m = 1.0 / ( alpham ( _threadargscomma_ _lv ) + betam ( _threadargscomma_ _lv ) ) * q10na ;
   ...
   tau_h = 1.218 + 42.043 * exp ( - ( pow( ( _lv + 38.1 ) , 2.0 ) ) / ( 2.0 * pow( 15.19 , 2.0 ) ) ) * q10na ;
   ...
   tau_u = 1.0 / ( alphau ( _threadargscomma_ _lv ) + betau ( _threadargscomma_ _lv ) ) * q10na ;
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  u = u0;
 {
   ...
   h = 1.0 / ( 1.0 + exp ( ( v + 32.2 ) / 4.0 ) ) ;
   s = 1.0 / ( 1.0 + exp ( ( v + 45.0 ) / 8.0 ) ) ;
   u = 1.0 / ( 1.0 + exp ( ( v + 51.0 ) / 8.0 ) ) ;
   }
