...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 km C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF5/km.mod\n");
...
double rates ( _threadargsprotocomma_ double _lv ) {
 ...
 ninf = 1.0 / ( 1.0 + exp ( - ( _lv + 30.0 ) / 6.0 ) ) ;
   tau_nf = 1.0 / ( ( 0.00395 * exp ( ( _lv + 30.0 ) / 40.0 ) ) + ( 0.00395 * exp ( - ( _lv + 30.0 ) / 20.0 ) * q10k ) ) ;
   if ( _lv < - 60.0 ) {
     tau_ns = 219.0 * q10k ;
     }
   else {
     tau_ns = 13.0 * _lv + 1000.0 * q10k ;
     }
