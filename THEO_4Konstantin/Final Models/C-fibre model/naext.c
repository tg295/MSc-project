...
#define nrn_init _nrn_init__naext
#define _nrn_initial _nrn_initial__naext
#define nrn_cur _nrn_cur__naext
#define _nrn_current _nrn_current__naext
#define nrn_jacob _nrn_jacob__naext
#define nrn_state _nrn_state__naext
#define _net_receive _net_receive__naext 
#define state state__naext 
...
extern Memb_func* memb_func;
 ...
 "setdata_naext", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define nao0 nao0_naext
 double nao0 = 154;
#define nabath0 nabath0_naext
 double nabath0 = 154;
 ...
 "nabath0_naext", &nabath0_naext,
 "nao0_naext", &nao0_naext,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 naext C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF4/naext.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dnao = ( 1e8 ) * ina / ( fhspace * FARADAY ) + ( nabath0 - nao ) / txfer ;
   }
 return _reset;
}
