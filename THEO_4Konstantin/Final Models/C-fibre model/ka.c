...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ka C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF5/ka.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   ...
   tau_n = 0.25 + 10.04 * exp ( - ( pow( ( _lv + 24.67 ) , 2.0 ) ) / ( 2.0 * pow( 34.8 , 2.0 ) ) ) * q10k ;
   tau_h = 20.0 + 50.0 * exp ( - ( pow( ( _lv + 40.0 ) , 2.0 ) ) / ( 2.0 * pow( 40.0 , 2.0 ) ) ) * q10k ;
   if ( tau_h < 5.0 ) {
     tau_h = 5.0 ;
     }
    return 0; }
