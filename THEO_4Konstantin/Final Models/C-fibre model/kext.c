...
#define nrn_init _nrn_init__kacc
#define _nrn_initial _nrn_initial__kacc
#define nrn_cur _nrn_cur__kacc
#define _nrn_current _nrn_current__kacc
#define nrn_jacob _nrn_jacob__kacc
#define nrn_state _nrn_state__kacc
#define _net_receive _net_receive__kacc 
#define state state__kacc 
...
extern Memb_func* memb_func;
 ...
 "setdata_kacc", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define ko0 ko0_kacc
 double ko0 = 5.6;
#define kbath0 kbath0_kacc
 double kbath0 = 5.6;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kacc C:/Users/theog/OneDrive/Desktop/ICL/Thesis/Final models/Unmyelinated with LDIFF4/kext.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dko = ( 1e8 ) * ik / ( fhspace * FARADAY ) + ( kbath0 - ko ) / txfer ;
   }
 return _reset;
}
